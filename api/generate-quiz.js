...
이전과 다른 새로운 문항을 만들어 주세요. 랜덤 시드: ${Date.now()}
...
이전과 다른 새로운 시나리오를 만들어 주세요. 랜덤 시드: ${Date.now()}
...
- 정상(isPhishing: false): link는 공식 도메인, clues에 정상인 이유 3~4개
- 정상 이메일의 link는 null 대신 실제 공식 도메인 URL 사용
